...
const uint8_t CHAR_UUID_MEATSTICK_CYBER_T0[16] = {0x11, 0x88, 0x66, 0x00, 0x33, 0x66, 0x77, 0x88, 0x99, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66};
const uint8_t CHAR_UUID_MEATSTICK_CYBER_MINI_T0[16] = {0x11, 0x88, 0x00, 0x88, 0x33, 0x66, 0x77, 0x88, 0x99, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66};

class BleTemperatureMeatStick : public BleSensorBase
{
public:
